...
using Oauth2Sample.STS.Identity.Configuration;
using Oauth2Sample.STS.Identity.Configuration.ApplicationParts;
using Oauth2Sample.STS.Identity.Configuration.Constants;
using Oauth2Sample.STS.Identity.Configuration.Interfaces;
using Oauth2Sample.STS.Identity.Helpers.Localization;

namespace Oauth2Sample.STS.Identity.Helpers
{
