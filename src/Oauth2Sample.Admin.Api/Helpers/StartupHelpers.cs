...
using Oauth2Sample.Admin.Api.Configuration.ApplicationParts;
using Oauth2Sample.Admin.Api.Configuration.AuditLogging;
using Oauth2Sample.Admin.Api.Configuration.Constants;
using Oauth2Sample.Admin.Api.Helpers.Localization;
...
namespace Oauth2Sample.Admin.Api.Helpers
{
