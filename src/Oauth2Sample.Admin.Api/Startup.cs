...
using Oauth2Sample.Admin.Api.Configuration;
using Oauth2Sample.Admin.Api.Configuration.Authorization;
using Oauth2Sample.Admin.Api.Configuration.Constants;
using Oauth2Sample.Admin.Api.ExceptionHandling;
using Oauth2Sample.Admin.Api.Helpers;
using Oauth2Sample.Admin.Api.Mappers;
using Oauth2Sample.Admin.Api.Resources;
...
using Oauth2Sample.Admin.EntityFramework.Shared.Entities.Identity;
using Skoruba.Duende.IdentityServer.Shared.Configuration.Helpers;
using Oauth2Sample.Shared.Dtos;
using Oauth2Sample.Shared.Dtos.Identity;

namespace Oauth2Sample.Admin.Api
{
